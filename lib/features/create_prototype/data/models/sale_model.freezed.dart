...
mixin _$SaleModel {
 ...
 String get id; String get idClient; double get total; int get totalProducts; String get date; String get moneda;@ProductListConverter() List<ProductInCartModel> get products; double get discount; int get typePayment; int get last4Digits;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SaleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.idClient, idClient) || other.idClient == idClient)&&(identical(other.total, total) || other.total == total)&&(identical(other.totalProducts, totalProducts) || other.totalProducts == totalProducts)&&(identical(other.date, date) || other.date == date)&&(identical(other.moneda, moneda) || other.moneda == moneda)&&const DeepCollectionEquality().equals(other.products, products)&&(identical(other.discount, discount) || other.discount == discount)&&(identical(other.typePayment, typePayment) || other.typePayment == typePayment)&&(identical(other.last4Digits, last4Digits) || other.last4Digits == last4Digits));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,idClient,total,totalProducts,date,moneda,const DeepCollectionEquality().hash(products),discount,typePayment,last4Digits);

@override
String toString() {
  return 'SaleModel(id: $id, idClient: $idClient, total: $total, totalProducts: $totalProducts, date: $date, moneda: $moneda, products: $products, discount: $discount, typePayment: $typePayment, last4Digits: $last4Digits)';
}
...
@useResult
$Res call({
 String id, String idClient, double total, int totalProducts, String date, String moneda,@ProductListConverter() List<ProductInCartModel> products, double discount, int typePayment, int last4Digits
});
...
/// Create a copy of SaleModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? idClient = null,Object? total = null,Object? totalProducts = null,Object? date = null,Object? moneda = null,Object? products = null,Object? discount = null,Object? typePayment = null,Object? last4Digits = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String idClient,  double total,  int totalProducts,  String date,  String moneda, @ProductListConverter()  List<ProductInCartModel> products,  double discount,  int typePayment,  int last4Digits)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaleModel() when $default != null:
return $default(_that.id,_that.idClient,_that.total,_that.totalProducts,_that.date,_that.moneda,_that.products,_that.discount,_that.typePayment,_that.last4Digits);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String idClient,  double total,  int totalProducts,  String date,  String moneda, @ProductListConverter()  List<ProductInCartModel> products,  double discount,  int typePayment,  int last4Digits)  $default,) {final _that = this;
switch (_that) {
case _SaleModel():
return $default(_that.id,_that.idClient,_that.total,_that.totalProducts,_that.date,_that.moneda,_that.products,_that.discount,_that.typePayment,_that.last4Digits);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String idClient,  double total,  int totalProducts,  String date,  String moneda, @ProductListConverter()  List<ProductInCartModel> products,  double discount,  int typePayment,  int last4Digits)?  $default,) {final _that = this;
switch (_that) {
case _SaleModel() when $default != null:
return $default(_that.id,_that.idClient,_that.total,_that.totalProducts,_that.date,_that.moneda,_that.products,_that.discount,_that.typePayment,_that.last4Digits);case _:
  return null;
...
class _SaleModel implements SaleModel {
  const _SaleModel({this.id = '', required this.idClient, required this.total, required this.totalProducts, required this.date, required this.moneda, @ProductListConverter() required final  List<ProductInCartModel> products, required this.discount, required this.typePayment, required this.last4Digits}): _products = products;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,idClient,total,totalProducts,date,moneda,const DeepCollectionEquality().hash(_products),discount,typePayment,last4Digits);
...
/// Create a copy of SaleModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? idClient = null,Object? total = null,Object? totalProducts = null,Object? date = null,Object? moneda = null,Object? products = null,Object? discount = null,Object? typePayment = null,Object? last4Digits = null,}) {
